...
public class Tela extends JFrame {
    ...
    private void drawSegundoPainelProfessores() {
        ...
        JButton btnRemoveDiciplina = new JButton("Remove diciplina (CODIGO)");
    ...
    public boolean containsCode(String code) {
        return modelAlunos.contains(code) || modelDiciplinas.contains(code) || modelProfessores.contains(code);
    }
}
